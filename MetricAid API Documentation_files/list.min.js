				...
				b.exports = function (a) {
					var b,
						...
						g = {
							...
							item: function (a) {
								a.found = !1;
								for (var b = 0, d = c.length; b < d; b++) if (g.values(a.values(), c[b])) return void (a.found = !0);
							},
							values: function (c, e) {
					...
					var b = {
						...
						c = function () {
							...
							d
								...
								: ((c = arguments[1] || c), (c.valueName = arguments[0]), (c.order = c.order || 'asc'), (c.insensitive = 'undefined' == typeof c.insensitive || c.insensitive)),
								b.clear(),
								b.setOrder(c),
				...
				var d = function (a) {
					...
					(this.clearSourceItem = function (b, c) {
						for (var d = 0, e = c.length; d < e; d++) {
							var f;
							if (c[d].data) for (var g = 0, h = c[d].data.length; g < h; g++) b.setAttribute('data-' + c[d].data[g], '');
						...
						(this.getItemSource = function (b) {
							if (void 0 === b) {
								for (var c = a.list.childNodes, d = 0, e = c.length; d < e; d++) if (void 0 === c[d].data) return c[d].cloneNode(!0);
							} else {
								if (/<tr[\s>]/g.exec(b)) {
						...
						(this.get = function (b, d) {
							...
							for (var e = {}, f = 0, g = d.length; f < g; f++) {
								var h;
								if (d[f].data) for (var i = 0, j = d[f].data.length; i < j; i++) e[d[f].data[i]] = a.utils.getAttribute(b.elm, 'data-' + d[f].data[i]);
								else
									d[f].attr && d[f].name
							...
							var e = function (b) {
									for (var c = 0, d = a.valueNames.length; c < d; c++)
										if (a.valueNames[c].data) {
											for (var e = a.valueNames[c].data, f = 0, g = e.length; f < g; f++) if (e[f] === b) return { data: b };
										} else {
		...
		12: [
			function (a, b, c) {
				b.exports = function (a, b) {
					...
					if (!c) for (var d = a.attributes, e = d.length, f = 0; f < e; f++) void 0 !== b[f] && b[f].nodeName === b && (c = b[f].nodeValue);
					return c;
				};
			},
			{},
