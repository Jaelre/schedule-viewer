...
(function () {
		...
		if (e) {
			...
			f.onload = f.onreadystatechange = function () {
				g ||
					...
					((g = !0), d && d(null), (f.onload = f.onreadystatechange = null), 'HEAD' == f.parentNode.tagName && e.removeChild(f));
			};
			e.appendChild(f);
			setTimeout(function () {
	...
	ua.prototype.load = function (a) {
		...
		for (d = e.length; b < d; b++)
			if (((c = e[b].split(':')), c[1])) for (var h = c[1].split(','), m = 0; m < h.length; m += 1) k.push(new H(c[0], h[m]));
	...
	function Ea(a) {
		for (var b = a.f.length, d = 0; d < b; d++) {
			...
			if (2 <= c.length) {
				...
				0 < g.length && (f = g);
				3 == c.length && ((c = c[2]), (g = []), (c = c ? c.split(',') : g), 0 < c.length && (c = Aa[c[0]]) && (a.c[e] = c));
			}
