...
require(['jquery', 'lodash', 'locales', 'handlebarsExtended', 'apiProject', 'apiData', 'prettify', 'utilsSampleRequest', 'semver', 'webfontloader', 'bootstrap', 'pathToRegexp', 'list'], function (
	$,
	_,
	locale,
	Handlebars,
