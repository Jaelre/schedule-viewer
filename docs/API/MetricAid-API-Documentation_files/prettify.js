...
*/
	...
	(function () {
		function T(a) {
			...
			function v(e) {
				for (
					var a = e.source.match(/(?:\[(?:[^\x5C\x5D]|\\[\s\S])*\]|\\u[A-Fa-f0-9]{4}|\\x[A-Fa-f0-9]{2}|\\[0-9]+|\\[^ux0-9]|\(\?[:!=]|[\(\)\^]|[^\x5B\x5C\(\)\^]+)/g),
						c = a.length,
						d = [],
						g = 0,
						h = 0;
		...
		function V(a) {
			for (var d = void 0, f = a.firstChild; f; f = f.nextSibling) var b = f.nodeType, d = 1 === b ? (d ? a : f) : 3 === b ? (W.test(f.nodeValue) ? a : d) : d;
			return d === a ? void 0 : d;
		}
		function G(a, d) {
			function f(a) {
		...
		var E = window,
			...
			F = [
				[C, 'auto,case,char,const,default,double,enum,extern,float,goto,inline,int,long,register,short,signed,sizeof,static,struct,switch,typedef,union,unsigned,void,volatile'],
		...
		var Y = (E.PR = {
				...
				prettyPrint: (E.prettyPrint = function (a, d) {
					...
					for (
						var b = d || document.body, v = b.ownerDocument || document, b = [b.getElementsByTagName('pre'), b.getElementsByTagName('code'), b.getElementsByTagName('xmp')], t = [], n = 0;
						n < b.length;
						++n
					)
